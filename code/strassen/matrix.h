...
void naive_matrix_multiplication_rect(float** C, float const* const* const A, float const* const* const B, const size_t Arow, const size_t Acol, const size_t Bcol);
...
float** pad_new(float const* const* const ORIG, const size_t Orows, const size_t Ocols, const size_t Nrows, const size_t Ncols, const size_t RowSeek, const size_t ColSeek);
