...
size_t get_array_minimum_index(const void* A, const unsigned int num_of_elem, const size_t elem_size,
...
void* init_array(void* A, const unsigned int num_of_elem, const size_t elem_size, total_order_type cmp)
{
...
void keep_extracting_the_min_array(void* array)
{
    ...
    {
        min_idx = get_array_minimum_index(Array->A, i, Array->elem_size, Array->cmp);
